...
const getTheme = () => {
  ...
  if (dark) {
    return {
      ...
      dropZone: 'var(--color-primary-faint)', swimlaneBg: 'rgba(255, 255, 255, 0.03)',
  ...
  return {
    ...
    dropZone: 'var(--color-primary-faint)', swimlaneBg: 'rgba(0, 0, 0, 0.025)',
