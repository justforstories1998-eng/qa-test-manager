...
const getTheme = () => {
  ...
  if (dark) {
    return {
      bgPrimary: 'var(--bg-app)', bgSecondary: 'var(--bg-card)', bgTertiary: 'var(--bg-inset)',
      bgCard: 'var(--bg-card)', bgCardHover: 'var(--bg-card-hover)', bgElevated: 'var(--bg-elevated)',
      bgInput: 'var(--bg-input)', bgOverlay: 'var(--bg-overlay)', bgGlass: 'var(--bg-card)',
      textPrimary: 'var(--text-primary)', textSecondary: 'var(--text-secondary)', textMuted: 'var(--text-muted)', textInverse: 'var(--text-inverse)',
      borderPrimary: 'var(--border-default)', borderSecondary: 'var(--border-light)', borderHover: 'var(--border-strong)',
      borderFocus: 'var(--focus-ring)',
      accentPrimary: 'var(--color-primary)', accentSecondary: 'var(--color-primary-light)',
      accentGradient: 'linear-gradient(135deg, #6366f1, #7c3aed)', accentGlow: 'var(--color-primary-faint)', accentSoft: 'var(--color-primary-soft)',
      successColor: 'var(--color-success)', warningColor: 'var(--color-warning)', dangerColor: 'var(--color-danger)',
      shadowSm: 'var(--shadow-sm)', shadowMd: 'var(--shadow-md)', shadowLg: 'var(--shadow-lg)', shadowXl: 'var(--shadow-xl)',
      shadowGlow: 'var(--shadow-md)',
      scrollThumb: 'rgba(255, 255, 255, 0.07)', scrollThumbHover: 'rgba(255, 255, 255, 0.14)',
      rowEven: 'rgba(255, 255, 255, 0.01)', rowOdd: 'transparent', rowHover: 'var(--color-primary-faint)',
    };
  }
  return {
    bgPrimary: 'var(--bg-app)', bgSecondary: 'var(--bg-card)', bgTertiary: 'var(--bg-inset)',
    ...
    rowEven: 'rgba(0, 0, 0, 0.015)', rowOdd: 'transparent', rowHover: 'var(--color-primary-faint)',
  };
};
